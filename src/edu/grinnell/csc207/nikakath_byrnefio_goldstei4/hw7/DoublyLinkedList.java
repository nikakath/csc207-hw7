...
public class DoublyLinkedList<T> implements ListOf<T> {
     ...
     * 
     * @pre Valid cursors. start precedes end.
     * @throws Exception
     *             If the cursors are invalid.
     * 
     * @post returns vals, a sublist containing all elements between start and
     ...
     * @throws Exception
     *             If the cursors are invalid.
     * @returns true if c1 precedes c2, including if they point to the same
